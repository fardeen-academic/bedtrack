...
<body>
    ...
    <div class="bg-dark main container-fluid">
        ...
        <div class="float-start text-light mt-5">
            ...
            <a href="index.php" class="btn btn-light px-4 py-2">Login</a>   
        </div>
        ...
        <div class="card float-end">
            ...
            <div class="card-body">
                ...
                <div class="form-floating mb-4">
                    <input class="form-control" type="text" name="name" id="email" placeholder="Your Email">
            ...
            <div class="card-footer">
                <button class="btn btn-primary my-2 py-2" type="submit">Sign Up</button>
            </div>
            </form>
        </div>
    </div>
